...
const apiUrl = "https://workasana.up.railway.app/api/tasks"
...
export const completedTaskUpdate = createAsyncThunk("taskCompleted/update", async (updatedData) => {
  ...
  try {
    const response = await axios.post(`https://workasana.up.railway.app/api/tasks/complete/${updatedData.id}`,updatedData,{headers:headers()})
    return response.data
  }
  catch (error)
  {
